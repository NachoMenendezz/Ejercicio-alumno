    ...
    while(true){
        ...
        switch(opc){
            ...
            case 2:menuMateria(materia);
                break;
            case 3:menuInscripcion(inscripcion);
            break;
...
void menuInscripcion(Inscripcion *inscripcion)
{
int pos=0;
int opc;
    while(true)
...
switch (opc)
        {
case 1: cargarInscripcion(inscripcion,pos);
break;
case 0:return;
...
cont++;
pos++;
cout<<"DESEAS INSCRIBIRTE A OTRA MATERIA MAS ? "<<endl<<"1=SI, 2= NO"<<endl;
int opc;
cin>>opc;
if (opc==2) return;
